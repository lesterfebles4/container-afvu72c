...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-afvu72c.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-afvu72c.containers.anotherwebservice.com/
...
```
git clone git@github.com:lesterfebles4/container-afvu72c.git
cd container-afvu72c
```
...
```
docker attach container-afvu72c
```
